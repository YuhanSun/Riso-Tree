...
/**
 * Simple encoder that stores geometries as an array of float values. Only supports LineString
 * geometries.
 * 
 * @TODO: Consider generalizing this code and making a float[] type geometry store available in the
 *        library
