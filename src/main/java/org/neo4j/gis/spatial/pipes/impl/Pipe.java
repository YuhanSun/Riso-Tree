...
/**
 * The generic interface for any Pipe implementation. A Pipe takes/consumes objects of type S and
 * returns/emits objects of type E. S refers to <i>starts</i> and the E refers to <i>ends</i>.
 *
...
public interface Pipe<S, E> extends Iterator<E>, Iterable<E> {
  ...
  /**
   * A pipe may maintain state. Reset is used to remove state. The general use case for reset() is
   * to reuse a pipe in another computation without having to create a new Pipe object.
   */
  public void reset();
