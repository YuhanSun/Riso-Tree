...
/**
 * Computes the symmetric difference of the given geometry with item geometry. Item geometry is
 * replaced by pipe output unless an alternative property name is given in the constructor.
 */
