...
/**
 * Densify geometries by inserting extra vertices along the line segments in the geometry. The
 * densified geometry contains no line segment which is longer than the given distance tolerance.
