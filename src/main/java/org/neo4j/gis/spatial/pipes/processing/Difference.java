...
/**
 * Computes a geometry representing the points making up item geometry that do not make up the given
 * geometry. Item geometry is replaced by pipe output unless an alternative property name is given
 * in the constructor.
 */
