...
public class ExtractOSMPoints extends AbstractExtractGeoPipe {
  ...
  protected void extract(GeoPipeFlow pipeFlow) {
    ...
    TraversalDescription td =
        node.getGraphDatabase().traversalDescription().evaluator(new Evaluator() {
          @Override
        ...
        }).expand(new OrderedByTypeExpander().add(OSMRelation.FIRST_NODE, Direction.OUTGOING)
            .add(OSMRelation.NEXT, Direction.OUTGOING).add(OSMRelation.NODE, Direction.OUTGOING))
