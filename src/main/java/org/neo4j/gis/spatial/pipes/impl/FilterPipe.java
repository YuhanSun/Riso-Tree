...
/**
 * A FilterPipe has no specified behavior save that it takes the same objects it emits. This
 * interface is used to specify that a Pipe will either emit its input or not.
 *
