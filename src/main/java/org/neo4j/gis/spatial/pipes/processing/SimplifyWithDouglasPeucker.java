...
/**
 * Simplifies geometry for every item in the pipeline, using Douglas Peucker algorithm. Item
 * geometry is replaced by pipe output unless an alternative property name is given in the
 * constructor.
 */
