...
/**
 * Calculates boundary of every geometry in the pipeline. Item geometry is replaced by pipe output
 * unless an alternative property name is given in the constructor.
 */
