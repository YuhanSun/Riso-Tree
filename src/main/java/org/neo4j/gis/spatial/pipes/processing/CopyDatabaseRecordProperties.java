 ...
 * Since extracting properties from database Nodes can be expensive it must be done explicitly using
 * this pipe.<br>
 * This pipe is useful if you want to use pipes that filter by property value or pipes that process
 * property values.
 */
