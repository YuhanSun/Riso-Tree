...
/**
 * Intersects geometries of every item contained in the pipeline. This pipe groups every item in the
 * pipeline in a single item containing the geometry output of the intersection.
 */
