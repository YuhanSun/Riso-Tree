...
/**
 * Simplifies geometry for every item in the pipeline, using an algorithm that preserves geometry
 * topology. Item geometry is replaced by pipe output unless an alternative property name is given
 * in the constructor.
 */
