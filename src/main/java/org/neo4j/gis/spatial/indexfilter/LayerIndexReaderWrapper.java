...
/**
 * This class wraps a SpatialIndexReader instance, passing through all calls transparently. This is
 * a class that should not be used as it, as it provides not additional functionality. However
 * extending this class allows for wrapping an existing index and modifying its behaviour through
 * overriding only specific methods. For example, override the excecuteSearch method with a
