...
public interface EditableLayer extends Layer {
  ...
  /**
   * Update the geometry identified by the passed node id. This might be as simple as changing node
   * properties or it might require editing an entire sub-graph.
   * 
   * @param geometryNodeId
   */
