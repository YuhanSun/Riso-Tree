...
public class TraverserFactory {
  public static Traverser createTraverserInBackwardsCompatibleWay(
      TraversalDescription traversalDescription, Node layerNode) {
    try {
      try {
        return (Traverser) TraversalDescription.class.getDeclaredMethod("traverse", Node.class)
            .invoke(traversalDescription, layerNode);
      } catch (NoSuchMethodException e) {
        return (Traverser) TraversalDescription.class.getDeclaredMethod("traverse", Node[].class)
            .invoke(traversalDescription, new Object[] {new Node[] {layerNode}});
      }
