...
/**
 * FeatureWriter implementation. Instances of this class are created by Neo4jSpatialDataStore.
 * 
...
public class Neo4jSpatialFeatureWriter implements FeatureWriter<SimpleFeatureType, SimpleFeature> {
  ...
  private static final Logger LOGGER =
      org.geotools.util.logging.Logging.getLogger("org.neo4j.gis.spatial");
  ...
  public void remove() throws IOException {
    ...
    if (live != null) {
      ...
      listener.fireFeaturesRemoved(featureType.getTypeName(), transaction,
  ...
  public void write() throws IOException {
    ...
    if (live != null) {
      if (!live.equals(current)) {
        ...
        listener.fireFeaturesChanged(featureType.getTypeName(), transaction,
