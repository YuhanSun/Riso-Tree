...
/**
 * DataStoreFactorySpi implementation. It needs an "url" parameter containing a path of a Neo4j
 * neostore.id file.
 * 
...
public class Neo4jSpatialDataStoreFactory extends AbstractDataStoreFactory
  ...
  public static final Param DIRECTORY =
      new Param("The directory path of the Neo4j database: ", File.class, "db", true);

  public static final Param DBTYPE = new Param("dbtype", String.class, "must be 'neo4j'", true,
      "neo4j", new KVP(Param.LEVEL, "program"));
