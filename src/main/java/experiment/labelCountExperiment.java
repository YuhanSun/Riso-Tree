...
//			entityPath = String.format("/mnt/hgfs/Ubuntu_shared/GeoMinHop/data/%s/entity.txt", dataset);
			querygraphDir = String.format("/mnt/hgfs/Google_Drive/Projects/risotree/query/query_graph/labelCount/");
...
//			entityPath = String.format("D:\\Ubuntu_shared\\GeoMinHop\\data\\%s\\entity.txt", dataset);
			querygraphDir = String.format("D:\\Google_Drive\\Projects\\risotree\\query\\query_graph\\labelCount\\");
...
//			convertQueryGraph();
	...
	/**
	 * Already has query graph for 100 labels.
	 * Only need to convert it to other by changing label list 
	 * of the query graph
	 */
