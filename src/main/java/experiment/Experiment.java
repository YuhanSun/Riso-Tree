...
//		SpatialFirstList(5);
	...
	public static void SpatialFirstList_Block(int query_id)
	{
		...
		switch (systemName) {
		case Ubuntu:
			result_detail_path = String.format("/mnt/hgfs/Experiment_Result/Riso-Tree/%s/spa_first_list_Block_%d_API.txt", dataset, query_id);
			result_avg_path = String.format("/mnt/hgfs/Experiment_Result/Riso-Tree/%s/spa_first_list_Block_%d_API_avg.txt", dataset, query_id);
			break;
		case Windows:
			result_detail_path = String.format("D:\\Google_Drive\\Experiment_Result\\Riso-Tree\\%s\\spa_first_list_Block_%d_API.txt", dataset, query_id);
			result_avg_path = String.format("D:\\Google_Drive\\Experiment_Result\\Riso-Tree\\%s\\spa_first_list_Block_%d_API_avg.txt", dataset, query_id);
			break;
		}
